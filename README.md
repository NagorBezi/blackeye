...
```
git clone https://github.com/NagorBezi/blackeye.git
cd blackeye
chmod +x ./setup.sh
./setup.sh
```
...
```./tmxsp.sh```
<p><a href="#"><img title="blackeye" src="https://i.imgur.com/YuAb55M.jpg"></a>
</p>
Note: Made for Educational Purposes,use it with mutual consent of the victim.
<p><a href="https://i.imgur.com/TJFmaGq.png"><img title="blackeye" src="https://i.imgur.com/TJFmaGq.png"></a>
</p>
